...
import { api, InteractionStats, Scenario } from "@/lib/api";
import { Bot, Cpu, Play, Activity, Zap, Globe } from "lucide-react";
import Link from "next/link";

const statCards = [
  { label: "Cognitive Capabilities", value: "21", icon: Cpu, color: "from-violet-500 to-purple-500" },
  { label: "API Endpoints", value: "97", icon: Zap, color: "from-blue-500 to-cyan-500" },
  { label: "AI Models", value: "12+", icon: Globe, color: "from-emerald-500 to-teal-500" },
  { label: "Active Agents", value: "–", icon: Bot, color: "from-amber-500 to-orange-500" },
];
          ...
          <div className="bg-zinc-900/40 border border-zinc-800 rounded-xl p-5">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-emerald-400 text-sm font-medium">
                {interactions ? `${interactions.total_interactions} interactions tracked` : "No data yet"}
              </span>
            </div>
