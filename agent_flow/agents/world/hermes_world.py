...
Each agent uses Hermes Agent with DeepSeek to:
- Think, ask questions, answer naturally
- Learn from every conversation
- Develop a unique personality

No hardcoded responses. Everything is generated by the model.
"""
...
class HermesAgentBrain:
    ...
    def summary(self) -> dict:
        return {
            ...
            "skills": {k: round(v, 2) for k, v in sorted(self.skills.items(), key=lambda x: -x[1])},
